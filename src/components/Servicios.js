...
const Servicios = () => {
  ...
  const cargarServicios = async (id_negocio) => {
    const token = localStorage.getItem('token');
    try {
      const response = await axios.get(`https://rheaf-production.up.railway.app/api/servicios/negocio/${id_negocio}`, {
        headers: { Authorization: `Bearer ${token}` },
      });
  ...
  const cargarEmpleados = async (id_negocio) => {
    const token = localStorage.getItem('token');
    try {
      const response = await axios.get(`https://rheaf-production.up.railway.app/api/empleados/negocio/${id_negocio}/empleados`, {
        headers: { Authorization: `Bearer ${token}` },
      });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const url = editingId
        ? `https://rheaf-production.up.railway.app/api/servicios/${editingId}`
        : 'https://rheaf-production.up.railway.app/api/servicios';
  ...
  const handleDelete = async (id) => {
    const token = localStorage.getItem('token');
    try {
      await axios.delete(`https://rheaf-production.up.railway.app/api/servicios/${id}`, {
        headers: { Authorization: `Bearer ${token}` },
      });
