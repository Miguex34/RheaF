    ...
    const handleConfirmarReserva = async () => {
        ...
        try {
            ...
            if (!clienteId && reservaInvitado) {
                ...
                const responseCliente = await axios.post('https://rheaf-production.up.railway.app/api/clientes/invitado', {
            ...
            // Crear reserva
            await axios.post('https://rheaf-production.up.railway.app/api/reserva-horario/crear', {
                clienteId,
