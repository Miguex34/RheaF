        ...
        const fetchDatos = async () => {
            try {
                const generalResponse = await axios.get(
                    `https://rheaf-production.up.railway.app/api/reserva-horario/disponibilidad/general/${negocioId}/${servicioId}`
                );

                const empleadosResponse = await axios.get(
                    `https://rheaf-production.up.railway.app/api/reserva-horario/disponibilidad/empleados/${negocioId}/${servicioId}`
                );
    ...
    const handleSeleccionarEmpleado = async (empleado) => {
        ...
        try {
            const response = await axios.get(
                `https://rheaf-production.up.railway.app/api/reserva-horario/disponibilidad/empleado/${negocioId}/${servicioId}/${empleado.id}`
            );
